...
##  C:\Users\alexl\AppData\Local\Temp\RtmpK8WHQW\downloaded_packages
\end{verbatim}
...
\addcontentsline{toc}{subsubsection}{\texttt{spotify\_songs} dataset}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-73-2.pdf}

\hypertarget{movies-dataset}{%
\subsubsection*{\texorpdfstring{\texttt{movies} dataset}{movies dataset}}\label{movies-dataset}}
\addcontentsline{toc}{subsubsection}{\texttt{movies} dataset}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-74-2.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Convert to Date and remove NAs}
\NormalTok{spotify\_songs}\SpecialCharTok{$}\NormalTok{track\_album\_release\_date }\OtherTok{\textless{}{-}} \FunctionTok{ymd}\NormalTok{(spotify\_songs}\SpecialCharTok{$}\NormalTok{track\_album\_release\_date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{movies}\SpecialCharTok{$}\NormalTok{year }\OtherTok{\textless{}{-}} \FunctionTok{as.Date}\NormalTok{(}\FunctionTok{ISOdate}\NormalTok{(movies}\SpecialCharTok{$}\NormalTok{year, }\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{))}

\NormalTok{movies }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(year, binary) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{avg\_intgross =} \FunctionTok{mean}\NormalTok{(intgross, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ungroup}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ year, }\AttributeTok{y =}\NormalTok{ avg\_intgross, }\AttributeTok{color =}\NormalTok{ binary)) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{() }\SpecialCharTok{+}
    \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Bechdel International Gross Through the Years"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{xlab}\NormalTok{(}\StringTok{"Movie Release Year"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{ylab}\NormalTok{(}\StringTok{"International Gross (2013)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\addcontentsline{toc}{subsection}{Box Plot}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-78-2.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-80-2.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-81-2.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-82-2.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-83-2.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-84-2.pdf}
...
\addcontentsline{toc}{subsection}{Ridgeline Plot}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-86-2.pdf}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-87-2.pdf}
...
\addcontentsline{toc}{subsection}{Advanced Versions}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mode\_genre }\OtherTok{\textless{}{-}}\NormalTok{ spotify\_songs }\SpecialCharTok{\%\textgreater{}\%} 
...
\addcontentsline{toc}{section}{Inferential Analysis}
