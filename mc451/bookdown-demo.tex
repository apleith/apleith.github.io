...
\FunctionTok{t.test}\NormalTok{(spotify\_songs\_ttest}\SpecialCharTok{$}\NormalTok{track\_popularity }\SpecialCharTok{\textasciitilde{}}\NormalTok{ spotify\_songs\_ttest}\SpecialCharTok{$}\NormalTok{playlist\_genre, }\AttributeTok{var.equal =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Paired t{-}test (Hypothetical pre and post columns)}
\FunctionTok{t.test}\NormalTok{(survivor}\SpecialCharTok{$}\NormalTok{viewers\_premier, survivor}\SpecialCharTok{$}\NormalTok{viewers\_finale, }\AttributeTok{paired =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
