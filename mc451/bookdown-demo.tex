...
\addcontentsline{toc}{section}{Navigating the RStudio Interface}
...
\addcontentsline{toc}{section}{Cleaning Data for Visualizations and Analyses}
...
\subsubsection*{\texorpdfstring{Using \texttt{dplyr} for Filtering, Selecting, and Mutating Data}{Using dplyr for Filtering, Selecting, and Mutating Data}}\label{using-dplyr-for-filtering-selecting-and-mutating-data}}
\addcontentsline{toc}{subsubsection}{Using \texttt{dplyr} for Filtering, Selecting, and Mutating Data}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{  spotify\_songs}\SpecialCharTok{$}\NormalTok{track\_album\_release\_date }\OtherTok{\textless{}{-}} \FunctionTok{as.Date}\NormalTok{(spotify\_songs}\SpecialCharTok{$}\NormalTok{track\_album\_release\_date, }\AttributeTok{format=}\StringTok{"\%Y{-}\%m{-}\%d"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## Only 10 Github queries remaining until 2023-10-12 10:27:55 AM CDT.
\end{verbatim}
...
\begin{verbatim}
## Only 9 Github queries remaining until 2023-10-12 10:27:54 AM CDT.
\end{verbatim}
...
\begin{verbatim}
## Only 8 Github queries remaining until 2023-10-12 10:27:54 AM CDT.
\end{verbatim}
...
\begin{verbatim}
## Only 7 Github queries remaining until 2023-10-12 10:27:55 AM CDT.
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{writers }\OtherTok{\textless{}{-}}\NormalTok{ tuesdata}\SpecialCharTok{$}\NormalTok{writers}
\NormalTok{directors }\OtherTok{\textless{}{-}}\NormalTok{ tuesdata}\SpecialCharTok{$}\NormalTok{directors}
\NormalTok{episodes }\OtherTok{\textless{}{-}}\NormalTok{ tuesdata}\SpecialCharTok{$}\NormalTok{episodes}
\NormalTok{imdb }\OtherTok{\textless{}{-}}\NormalTok{ tuesdata}\SpecialCharTok{$}\NormalTok{imdb}
\end{Highlighting}
\end{Shaded}
